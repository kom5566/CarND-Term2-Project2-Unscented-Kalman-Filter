...
UKF::UKF() {
	...
	// init lambda spreading parameter
	lambda_ = 3 - n_x_;

	// init augmented lambda spreading parameter
	n_aug_ = 7;
...
// velocity not initialization from first laser
// avoid zeroes
 ...
 for (int i = 1; i < n_sig_; i++) { weights_(i) = 0.5 / (lambda_ + n_aug_); }
...
//delta t generation and prediction
...
void UKF::Prediction(double delta_t) {
	...
	*****************************************************************************/
	...
	/*
	//Lesson7 , section18: Augmentaion Assignment 2
	*/
	...
	*****************************************************************************/
	...
	/*
	//Lesson7 , section21: Augmentaion Assignment 2
	*/
 ...
 *****************************************************************************/
 ...
 /*
 //Lesson7 , section24: Predicted Mean and Corvariance Assignment 2
 */
 ...
 */
	void UKF::UpdateLidar(MeasurementPackage meas_package) {
		...
		*/
		...
		/*****************************************************************************
		*                       Update Lidar Measuremant                             *
		*****************************************************************************/

		int n_dim = 2;
		MatrixXd Zsig = Xsig_pred_.block(0, 0, n_dim, n_sig_);
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
  ...
  *****************************************************************************/
  ...
  /*
  //Lesson7 , section27: Predict Rader Measurement Assignment 2
  */
